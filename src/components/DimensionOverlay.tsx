...
export default function DimensionOverlay({
  ...
  const formatBlueprintArea = (area: number, unit: string, currentUnitSystem: 'metric' | 'imperial'): string => {
    ...
    // Handle each unit type - WITH CONVERSION LOGIC
    if (unit === 'mi') {
      // Check if user wants metric - then convert
      if (currentUnitSystem === 'metric') {
        const km2 = area * 2.59; // mi² to km²
      ...
      // Check if user wants imperial - then convert
      if (currentUnitSystem === 'imperial') {
        const mi2 = area / 2.59; // km² to mi²
        const acres = mi2 * 640;
        return `${formatArea(mi2, 'mi²')} (${formatAcres(acres)})`;
      }
      // Otherwise show km²
  ...
  const recalculateMeasurement = (measurement: Measurement, overrideCalibration?: typeof calibration): Measurement => {
    ...
    if (mode === 'distance') {
      ...
      const areaStr = formatBlueprintArea(area, activeCalibration?.unit || 'mm', unitSystem);
      const value = `${widthStr} × ${heightStr} (A: ${areaStr})`;
        ...
        if (m.area !== undefined) {
          ...
          if (isMapMode && mapScale) {
            ...
            if (unit === 'mi') {
              ...
              areaStr = formatBlueprintArea(m.area, unit as any, unitSystem);
            }
          }
                        ...
                        if (measurement.mode === 'distance') {
                          ...
                          if (diameter !== undefined && unit !== undefined) {
                            ...
                            if (measurement.depth !== undefined && measurement.depthUnit) {
                              // Convert depth to the same unit as the diameter
            ...
            <View style={[{ marginBottom: scaleMargin(8) }]}>
              <View style={{ flexDirection: 'row', backgroundColor: 'rgba(120, 120, 128, 0.18)', borderRadius: scaleBorderRadius(9), padding: scalePadding(1.5) }}>
                ...
                style={{
                  ...
                  borderRadius: scaleBorderRadius(7.5),
                  backgroundColor: mode === 'rectangle' ? 'rgba(255, 255, 255, 0.35)' : 'transparent',
              ...
              <Pressable
                ...
                style={{
                  ...
                  paddingHorizontal: scalePadding(2),
                  borderRadius: scaleBorderRadius(7.5),
                  backgroundColor: mode === 'circle' ? 'rgba(255, 255, 255, 0.35)' : 'transparent',
              ...
              <Pressable
                ...
                style={{
                  ...
                  paddingHorizontal: scalePadding(2),
                  borderRadius: scaleBorderRadius(7.5),
                  backgroundColor: mode === 'angle' ? 'rgba(255, 255, 255, 0.35)' : 'transparent',
              ...
              <Pressable
                ...
                style={{
                  ...
                  paddingHorizontal: scalePadding(2),
                  borderRadius: scaleBorderRadius(7.5),
                  backgroundColor: mode === 'distance' ? 'rgba(255, 255, 255, 0.35)' : 'transparent',
              ...
              <Pressable
                ...
                style={{
                  ...
                  paddingHorizontal: scalePadding(2),
                  borderRadius: scaleBorderRadius(7.5),
                  backgroundColor: mode === 'freehand' ? 'rgba(255, 255, 255, 0.35)' : 'transparent',
        ...
        <Pressable
          ...
          style={{
            ...
            right: isAutoCaptured
              ? 140  // Position right next to AUTO LEVEL badge (with gap) - moved left for spacing
              : (coinCircle || calibration || mapScale)
                ? 140  // Position left of Calibrated badge when no AUTO LEVEL - moved left for spacing
